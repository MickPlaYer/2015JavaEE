...
public class AlohaMessage implements Message {
	...
	// http://localhost:8080/00_hw10_WebService/spring/webservice/message/doAloha
	// http://ilab.csie.ntut.edu.tw:8080/00_hw10_WebService/spring/webservice/message/doAloha
