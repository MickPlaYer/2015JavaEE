...
{
	private final String CONTEXT_FILE = "test3/controller/spring.xml";
	...
	@Override
	public void buildCar(OwnerModel builder, String carName, int buildPrice) throws Exception
	{
		CarModel car = new CarModel(carName, buildPrice, builder.getId());
		builder.addCash(-buildPrice);
		builder.addAsset(buildPrice);
		builder.addCount(1);
		try
		{
			session = sessionFactory.openSession();
